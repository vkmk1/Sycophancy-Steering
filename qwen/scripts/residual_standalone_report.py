...
def main():
    ...
    # This avoids a fixed threshold that would bucket all Qwen residuals as
    # "low" (Qwen's largest role-CAA cosine is 0.079, well below any fixed
    # threshold that works for Gemma's 0.165 collaborator).
